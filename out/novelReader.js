...
class NovelReader {
    ...
    openNovelInTab() {
        ...
        if (this.panel) {
            ...
            // 创建新的webview面板
            this.panel = vscode.window.createWebviewPanel('novelReader', '小说阅读器', vscode.ViewColumn.One, {
                enableScripts: true,
    ...
    updateWebview() {
        ...
        this.panel.webview.html = this.getWebviewContent(this.currentChapter, info, fontSize, lineHeight);
    }
    getWebviewContent(chapter, info, fontSize, lineHeight) {
...
//# sourceMappingURL=novelReader.js.map